...
urlpatterns = [
    ...
    path("auth/send-register-otp/", send_register_otp, name="send_register_otp"),
    ...
    path("users/profile", Profile.as_view(), name="update_profil"),
    ...
    path(
        "toggle_active_listing/<int:listing_id>",
        toggle_active_listing,
        name="toggle_active_listing",
    ),
